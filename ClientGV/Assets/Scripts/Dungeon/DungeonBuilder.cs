...
public class DungeonBuilder : SingletonMonobehaviour<DungeonBuilder>
{
    ...
    public bool GenerateDungeon(DungeonLevelSO currentDungeonLevel)
    {
        ...
        while (!dungeonBuildSuccessful && dungeonBuildAttempts < Global.maxDungeonBuildAttempts)
        {
            ...
            while (!dungeonBuildSuccessful && dungeonRebuildAttemptsForNodeGraph <= Global.maxDungeonRebuildAttemptsForRoomGraph)
            {
