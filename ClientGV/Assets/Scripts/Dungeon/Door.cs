...
public class Door : MonoBehaviour
{
    ...
    {
        if (collision.tag == Global.playerTag || collision.tag == Global.playerWeapon)
        {
            OpenDoor();
        }
    }
    ...
    private void OnEnable()
    {
        ...
        animator.SetBool(Global.open, isOpen);
    }
    ...
    public void OpenDoor()
    {
        if (!isOpen)
        {
            ...
            animator.SetBool(Global.open, true);
    ...
    public void LockDoor()
    {
        ...
        animator.SetBool(Global.open, false);
    }
