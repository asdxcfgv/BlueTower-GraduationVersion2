...
public class InstantiatedRoom : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.tag == Global.playerTag && room != GameManager.Instance.GetCurrentRoom())
        {
            // Set room as visited
            this.room.isPreviouslyVisited = true;

            // Call room changed event
            StaticEventHandler.OnRoomChanged.Trigger(new RoomChangedEventArgs(room));
        }
    }
    ...
    private void AddObstaclesAndPreferredPaths()
    {
        ...
        for (int x = 0; x < (room.templateUpperBounds.x - room.templateLowerBounds.x + 1); x++)
        {
            ...
            {
                // Set default movement penalty for grid sqaures
                aStarMovementPenalty[x, y] = Global.defaultAStarMovementPenalty;
                ...
                {
                    aStarMovementPenalty[x, y] = Global.preferredPathAStarMovementPenalty;
                }
    ...
    private void AddDoorsToRooms()
    {
        ...
        foreach (Doorway doorway in room.doorWayList)
        {
            ...
            {
                float tileDistance = Global.tileSizePixels / Global.pixelsPerUnit;
                ...
                if (room.roomNodeType.isBossRoom)
                {
                    ...
                    GameObject skullIcon = Instantiate(GameResources.Instance.minimapBossIconPrefab, gameObject.transform);
