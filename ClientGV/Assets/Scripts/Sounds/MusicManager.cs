...
public class MusicManager : SingletonMonobehaviour<MusicManager>
{
    ...
    public void PlayMusic(MusicTrackSO musicTrack, float fadeOutTime = Global.musicFadeOutTime, float fadeInTime = Global.musicFadeInTime)
    {
        // Play music track
    ...
    public void SetMusicVolume(int musicVolume)
    {
        ...
        {
            GameResources.Instance.musicMasterMixerGroup.audioMixer.SetFloat("musicVolume", Global.LinearToDecibels(musicVolume));
        }
    }
}
