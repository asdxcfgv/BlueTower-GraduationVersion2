...
public class MovementByVelocity : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        movementByVelocityEvent.OnMovementByVelocity.Register(MovementByVelocityEvent_OnMovementByVelocity);
    }

    private void OnDisable()
    {
        // Unsubscribe from movement event
        movementByVelocityEvent.OnMovementByVelocity.UnRegister(MovementByVelocityEvent_OnMovementByVelocity);
    }
