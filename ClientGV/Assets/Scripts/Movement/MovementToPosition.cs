...
public class MovementToPosition : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        movementToPositionEvent.OnMovementToPosition.Register(MovementToPositionEvent_OnMovementToPosition);
    }

    private void OnDisable()
    {
        // Unsubscribe from movement to position event
        movementToPositionEvent.OnMovementToPosition.UnRegister(MovementToPositionEvent_OnMovementToPosition);
    }
