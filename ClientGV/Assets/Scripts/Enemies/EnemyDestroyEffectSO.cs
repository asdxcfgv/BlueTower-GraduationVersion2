...
[CreateAssetMenu(fileName = "EnemyDestroyEffect_", menuName = "Scriptable Objects/Enemy/Enemy Destroy Effect")]
public class EnemyDestroyEffectSO : ScriptableObject
{
     #region Header WEAPON ENEMY DESTROY DETAILS
    [Space(10)]
    [Header("WEAPON ENEMY DESTROY DETAILS")]
    #endregion Header WEAPON ENEMY DESTROY DETAILS

    #region Tooltip
    [Tooltip("The color gradient for the effect.  This gradient show the color of particles during their lifetime - from left to right ")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("enemyDestroyEffectPrefab contains the particle system for the shoot effect - and is configured by the enemyDestroyEffect SO")]
    #endregion Tooltip
